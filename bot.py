...
async def voice_tracker():
    ...
    for guild in bot.guilds:
        ...
        for channel_id, members in rooms.items():
            ...
            for i in range(len(members)):
                for j in range(i + 1, len(members)):
                    ...
                    valid_continuous_users.add(user1.id)
                    valid_continuous_users.add(user2.id)
        ...
        for user_id in valid_continuous_users:
        ...
        for key in list(voice_sessions.keys()):
            ...
            if user_id not in valid_continuous_users:
